...
### F9 — 最强单 cell 富集: #24 UGT topic × UGT_inhibition
...
### F10 — PK-pure topics（mechanism-named clusters）
...
### F11 — PD-pure topics（clinical-named clusters）
...
### F12 — 结构分化（paper 核心 narrative）⭐

F10 + F11 联合揭示：**TCM-HDI 文献结构性双极**
PK 空间                                PD 空间
...
### F14 — Bridge clusters: hepatotoxicity (#17) 是毒性整合 hub
...
### F16 — 跨工具三角验证（method triangulation）✅
...
### §4.x.6 — Bridge clusters 与 PK/PD 整合
...
### §4.x.7 — Mechanism-name to mechanism alignment as internal validation
