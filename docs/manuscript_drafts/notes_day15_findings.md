...
### §4.x.9 -- Three-tier herb stratification 作为 methodological novelty
...
### §4.x.10 -- SJW (Hypericum perforatum / hyperforin) 作为 FULL_CHAIN exemplar
...
### §4.x.11 -- Mechanism-specific natural resolution layers as a generalizable principle
